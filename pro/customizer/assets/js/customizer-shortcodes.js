            ...
            "api_key": {
                control: {
                    label:
                        ...
                        " " +
                        "(<a target='_blank' href='https://extendthemes.com/go/mesmerize/maps-api-key'>" +
...
(function (root, CP_Customizer, $) {
    ...
    CP_Customizer.content.registerItem({
        "shortcode-content": {
            label: "[ ]",
            data: '<div data-editable="true" data-name="ope-custom-content-shortcode" data-content-shortcode="shortcode_placeholder">[shortcode_placeholder]</div>',
